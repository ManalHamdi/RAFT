...
python3 evaluate.py --name Avg_19_noNorm_photo_10spa_198 --dataset acdc --dataset_folder "/home/guests/manal_hamdi/manal/RAFT/datasets/ACDC_processed/" --gpus 0 --batch_size 1 --max_seq_len 4 --gamma 0.8 --restore_ckpt "october_checkpoints/Avg_19_noNorm_photo_10spa/Avg_19_noNorm_photo_10spa_198.pth" --output_file "debugging_exp_eval_results.txt"